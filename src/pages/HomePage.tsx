import { BarChart3, Camera, Search, ShoppingCart } from 'lucide-react'
...
export function HomePage({ products, loading, go }: { products: StockProduct[]; loading: boolean; go: (page: PageId) => void }) {
  ...
  return <section className="page"><div className="hero"><p>Live inventory</p><h1>Bharat Paints Employee Tools</h1><span>Find stock and product pictures in seconds.</span></div>
